          ...
          if (typeof screenfull !== 'undefined') {
              $DOC.on('click', '[data-toggle="fullscreen"]', function () {
                  if (screenfull.enabled) {
                      screenfull.toggle();
                      var height = document.getElementById('div_content_page').offsetHeight;
                      document.getElementById('content_page').style.height = (height - 6) + "px";
                  }
              ...
              if (screenfull.enabled) {
                  DOC.addEventListener(screenfull.raw.fullscreenchange, function () {
                      ...
                      var height = document.getElementById('div_content_page').offsetHeight;
                      document.getElementById('content_page').style.height = "0px";
                      (0, _jquery2.default)('[data-toggle="fullscreen"]').toggleClass('active', screenfull.isFullscreen);
                      height = document.getElementById('div_content_page').offsetHeight;
                      document.getElementById('content_page').style.height = (height - 6) + "px";
                  });
              }
          }
